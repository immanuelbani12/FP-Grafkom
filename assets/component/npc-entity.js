  ...
  class NPCController extends entity.Component {
    ...
    loadModels() {
      ...
      loader.load(this._params.resourceName, (glb) => {
        ...
        this._animations['idle'] = findAnim('Idle');
        this._animations['walk'] = findAnim('Walk');
        this._animations['death'] = findAnim('Death');
        this._animations['attack'] = findAnim('Bite_Front');
    ...
    updateAI(timeInSeconds) {
      ...
      if (currentState.Name == 'idle' ||
        ...
        this.onAIWalk(timeInSeconds);
      }
    }

    onAIWalk(timeInSeconds) {
    ...
    update(timeInSeconds) {
      ...
      this._stateMachine.updates(timeInSeconds, this._input);
